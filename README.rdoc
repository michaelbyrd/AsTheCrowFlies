...
of the problems are centered around asynchronus javascript request.  I have
never worked with them before so the idea of callbacks and not being able to
return something from a function gave me some trouble.
